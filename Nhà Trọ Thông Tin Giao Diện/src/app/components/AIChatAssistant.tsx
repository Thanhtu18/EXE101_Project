...
export const AIChatAssistant: React.FC = () => {
  ...
  const [selectedModel, setSelectedModel] = useState<"groq" | "gemini">("gemini"); // Set Gemini as default since it's "Free"
          ...
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-white/40">
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="text-[11px] font-bold bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-600 py-1 px-2 rounded-lg outline-none cursor-pointer transition-all"
              >

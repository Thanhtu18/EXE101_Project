...
import { Wifi, Tv, WashingMachine, Utensils, Refrigerator, Wind, Sofa, Phone, User, Calendar, Heart, GitCompare } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/app/components/ui/card';
import { Badge } from '@/app/components/ui/badge';
import { Button } from '@/app/components/ui/button';
import { ImageWithFallback } from '@/app/components/figma/ImageWithFallback';
import { VerificationBadge, UnverifiedWarning, LocationVerificationInfo } from './VerificationBadge';
    ...
    return (
      <div className="w-64">
        <div className="relative">
          ...
          >
            <Heart className={`size-4 ${favorite ? 'fill-red-500 text-red-500' : 'text-gray-600'}`} />
          </Button>
        </div>
        <div className="p-3">
          ...
          <div className="flex flex-wrap gap-1 mb-3">
            ...
            {activeAmenities.length > 4 && (
              <span className="text-xs text-gray-500">+{activeAmenities.length - 4} tiện ích</span>
            )}
          </div>
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-start gap-2">
          <div className="flex-1">
            ...
            <VerificationBadge 
              ...
              size="sm"
            />
            <p className="text-xs text-gray-600 mt-1.5 line-clamp-1">{property.address}</p>
          </div>
        </div>
      </CardHeader>
      <CardContent className="space-y-2.5 pt-0">
        ...
        <div>
          <p className="text-xs font-semibold mb-1.5 text-gray-700">Tiện ích:</p>
          ...
          {activeAmenities.length > 4 && (
            <p className="text-xs text-gray-500 mt-1">+{activeAmenities.length - 4} tiện ích khác</p>
          )}
        </div>

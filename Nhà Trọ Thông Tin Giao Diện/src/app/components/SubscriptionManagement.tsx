...
import {
  Check, X, Crown, Star, TrendingUp, Eye, Phone, MapPin,
  Download, CreditCard, Calendar, ArrowRight
} from 'lucide-react';

// Mock current subscription data
const currentSubscription = {
  planName: 'Gói Standard',
  planId: 'standard',
  status: 'active',
...
const usageStats = [
  { label: 'Lượt xem tin đăng', value: '247', subtitle: 'Tháng này', icon: Eye, color: 'text-blue-600' },
  { label: 'Người liên hệ', value: '12', subtitle: 'Tháng này', icon: Phone, color: 'text-green-600' },
  { label: 'Vị trí tìm kiếm TB', value: '#3', subtitle: 'Top 10%', icon: MapPin, color: 'text-purple-600' },
];

const comparisonFeatures = [
  { name: 'Số lượng tin đăng', standard: '5 tin', pro: '20 tin', highlighted: true },
...
export function SubscriptionManagement() {
  ...
  const progressPercent = (currentSubscription.daysRemaining / currentSubscription.totalDays) * 100;
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Gói đăng ký của bạn</h2>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Kích hoạt từ {new Date(currentSubscription.startDate).toLocaleDateString('vi-VN')}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-gray-600">
                    {currentSubscription.daysRemaining}/{currentSubscription.totalDays} ngày
                  </span>
                </div>
      ...
      <div className="text-center">
        ...
        >
          ...
          <ArrowRight className={`size-4 ml-2 transition-transform ${showComparison ? 'rotate-90' : ''}`} />
        </Button>
      </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    ...
                    <th className="text-center py-3 px-4 font-bold text-gray-900">Standard (hiện tại)</th>
                  ...
                  {comparisonFeatures.map((feature, idx) => (
                    ...
                    >
                      <td className="py-3 px-4 font-medium text-gray-900">
                        {feature.name}
                        {feature.highlighted && (
                          <span className="ml-2 text-xs text-yellow-600 font-semibold">⭐ Nổi bật</span>
                        )}
                      </td>
                      <td className="py-3 px-4 text-center">
                        {typeof feature.standard === 'boolean' ? (
                          ...
                          <span className="font-semibold text-gray-900">{feature.standard}</span>
                        )}
                      </td>
                      <td className="py-3 px-4 text-center bg-purple-50">
                        {typeof feature.pro === 'boolean' ? (
                          ...
                          <span className="font-bold text-purple-700">{feature.pro}</span>
                        )}
                      </td>
                    </tr>
                  ))}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Gói</th>
                  ...
                  <th className="text-center py-3 px-4 font-semibold text-gray-700">Hóa đơn</th>
                </tr>
              </thead>
              <tbody>
                {transactions.map((transaction) => (
                  <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">
                      <span className="font-semibold text-gray-900">{transaction.plan}</span>
                    </td>
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 mb-2">Cần tư vấn về gói dịch vụ?</h3>
              <p className="text-sm text-gray-700 mb-4">
                Đội ngũ hỗ trợ của chúng tôi sẵn sàng giúp bạn chọn gói phù hợp nhất.
              </p>

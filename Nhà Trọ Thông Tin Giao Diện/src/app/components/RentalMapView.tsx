    ...
    mockFacilities.forEach((facility) => {
      ...
      const popupContent = `
        <div style="min-width: 180px;">
          ...
          <h4 style="margin: 0 0 6px 0; font-size: 14px; font-weight: 600; color: #333;">
            ${facility.name}
          </h4>
          <p style="margin: 0 0 4px 0; font-size: 13px; color: #666;">
            ${facility.address}
          </p>
          ${facility.description ? `<p style="margin: 4px 0 0 0; font-size: 12px; color: #999; font-style: italic;">${facility.description}</p>` : ''}
        </div>
      `;

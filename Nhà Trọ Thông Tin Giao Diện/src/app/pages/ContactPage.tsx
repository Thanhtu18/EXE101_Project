              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@timnhatro.vn" className="text-blue-600 hover:underline">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:0243654321" className="text-blue-600 hover:underline">
                      024 3654 321
                    </a>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 bg-blue-50 rounded-lg p-6 border-2 border-blue-200">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                <p><strong>Q:</strong> Làm sao để xác thực tài khoản?</p>
                <p className="ml-4 text-gray-600">A: Bạn có thể xác thực qua SMS OTP hoặc GPS khi đăng tin.</p>
                
                <p className="mt-3"><strong>Q:</strong> Có mất phí khi đăng tin không?</p>
                <p className="ml-4 text-gray-600">A: Hiện tại dịch vụ hoàn toàn miễn phí.</p>
                
                <p className="mt-3"><strong>Q:</strong> Làm sao để báo cáo tin lừa đảo?</p>
                <p className="ml-4 text-gray-600">A: Vui lòng liên hệ email support@timnhatro.vn hoặc gọi hotline.</p>
              </div>
            </div>
          </div>
        </div>

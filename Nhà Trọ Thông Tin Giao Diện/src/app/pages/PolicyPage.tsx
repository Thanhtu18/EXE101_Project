        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600">Danh sách kiểm tra quan trọng</p>
              </div>
            </Card>
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex flex-col items-center text-center">
          ...
          <section className="mb-16">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-6">
                <p className="text-sm">
                  <strong>💡 Mẹo:</strong> In checklist này ra giấy và mang theo khi đi xem phòng. 
                  Đánh dấu từng mục để không bỏ sót điều quan trọng!
                </p>
              </div>
          ...
          <section>
            <Card className="p-8 text-center bg-gradient-to-r from-green-600 to-blue-600 text-white">
              ...
              <p className="mb-6">Đội ngũ hỗ trợ MapHome luôn sẵn sàng giúp bạn!</p>

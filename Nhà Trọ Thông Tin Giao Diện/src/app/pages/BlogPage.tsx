...
import {
  Calendar, User, Clock, Eye, Search, Bookmark, BookmarkCheck,
  ArrowRight, TrendingUp, Tag, ChevronLeft, ChevronRight, Mail,
...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Hướng dẫn chi tiết để bạn có thể tìm được phòng trọ phù hợp với nhu cầu và ngân sách của mình. Từ việc chọn khu vực, thương lượng giá đến các lưu ý khi ký hợp đồng thuê nhà.',
    author: 'Nguyễn Thị Lan',
    authorAvatar: 'TL',
    date: '15/02/2026',
    image: 'https://images.unsplash.com/photo-1547024842-a0e3d2127406?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHVkZW50JTIwc3R1ZHlpbmclMjBhcGFydG1lbnQlMjBIYW5vaXxlbnwxfHx8fDE3NzE5MTU5NzJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    excerpt: 'Tìm hiểu về cơ chế xác thực 3 cấp độ giúp bạn tránh xa các tin đăng lừa đảo và thông tin không chính xác trên MapHome.',
    author: 'Trần Minh Đức',
    authorAvatar: 'MĐ',
    date: '12/02/2026',
    image: 'https://images.unsplash.com/photo-1657040899628-f4a028c62fbf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcGFydG1lbnQlMjBzYWZldHklMjBzZWN1cml0eSUyMGxvY2t8ZW58MXx8fHwxNzcxOTE1OTczfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Tính năng',
    readTime: '6 phút',
    views: 3810,
    likes: 189,
  ...
  },
  {
    ...
    excerpt: 'Khảo sát thị trường phòng trọ tại 5 khu vực có mức giá phải chăng, thuận tiện cho sinh viên và người đi làm tại Hà Nội.',
    author: 'Lê Hoàng Nam',
    authorAvatar: 'HN',
    date: '08/02/2026',
    image: 'https://images.unsplash.com/photo-1536785438246-08198ab7dd6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZWlnaGJvcmhvb2QlMjBjb21tdW5pdHklMjBwZW9wbGV8ZW58MXx8fHwxNzcxOTE1OTc0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Thị trường',
    readTime: '7 phút',
    views: 7230,
    likes: 312,
  ...
  },
  {
    ...
    excerpt: 'Hiểu rõ quyền lợi và nghĩa vụ khi thuê phòng trọ để tránh những rắc rối không đáng có. Hợp đồng, đặt cọc, và xử lý tranh chấp.',
    author: 'Phạm Thu Hà',
    authorAvatar: 'TH',
    date: '05/02/2026',
    image: 'https://images.unsplash.com/photo-1666018215790-867b14fe4822?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob3VzZSUyMGtleSUyMGNvbnRyYWN0JTIwc2lnbmluZ3xlbnwxfHx8fDE3NzE5MTU5NzJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Pháp luật',
    readTime: '10 phút',
    views: 4150,
    likes: 198,
  ...
  },
  {
    ...
    excerpt: 'Biến phòng trọ nhỏ trở nên ấm cúng và xinh xắn với những mẹo decor đơn giản, tiết kiệm nhưng vô cùng hiệu quả.',
    author: 'Nguyễn Thị Lan',
    authorAvatar: 'TL',
    date: '01/02/2026',
    image: 'https://images.unsplash.com/photo-1718066236079-9085195c389e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3p5JTIwcm9vbSUyMGRlY29yYXRpb24lMjBwbGFudHN8ZW58MXx8fHwxNzcxOTE1OTczfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Mẹo hay',
    readTime: '5 phút',
    views: 6800,
    likes: 421,
  ...
  },
  {
    ...
    excerpt: 'Chia sẻ những cách tiết kiệm điện, nước, ăn uống thông minh cho sinh viên và người mới đi làm sống trong phòng trọ.',
    author: 'Trần Minh Đức',
    authorAvatar: 'MĐ',
    date: '28/01/2026',
    image: 'https://images.unsplash.com/photo-1561837581-abd854e0ee22?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWRnZXQlMjBzYXZpbmclMjBtb25leSUyMHBpZ2d5YmFua3xlbnwxfHx8fDE3NzE5MTU5NzR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Kinh nghiệm',
    readTime: '6 phút',
    views: 3290,
    likes: 156,
  ...
  },
  {
    ...
    excerpt: 'Tận dụng tính năng đặt lịch xem phòng trực tuyến để sắp xếp thời gian một cách khoa học và hiệu quả nhất.',
    author: 'Lê Hoàng Nam',
    authorAvatar: 'HN',
    date: '25/01/2026',
  ...
  },
  {
    ...
    excerpt: 'Danh sách 20+ điều cần kiểm tra kỹ khi đi xem phòng: từ điện nước, cửa khóa, tường nứt đến hàng xóm xung quanh.',
    author: 'Phạm Thu Hà',
    authorAvatar: 'TH',
    date: '20/01/2026',
  ...
  },
  {
    ...
    excerpt: 'Phân tích biến động giá thuê, nhu cầu tìm trọ và dự báo xu hướng thị trường nhà trọ tại Hà Nội trong năm 2026.',
    author: 'Trần Minh Đức',
    authorAvatar: 'MĐ',
    date: '15/01/2026',
...
const ALL_CATEGORIES = ['Tất cả', 'Kinh nghiệm', 'Hướng dẫn', 'Thị trường', 'Pháp luật', 'Mẹo hay', 'Tính năng'];

const POPULAR_TAGS = ['tìm trọ', 'sinh viên', 'Hà Nội', 'tiết kiệm', 'pháp luật', 'hợp đồng', 'decor', 'Trust is King', 'thị trường', 'mẹo hay'];
      ...
      <section className="relative bg-gradient-to-br from-green-700 via-emerald-700 to-teal-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-14 md:py-20 text-center">
          ...
          <p className="text-green-100 text-base md:text-lg max-w-2xl mx-auto mb-8">
            Chia sẻ thông tin hữu ích về việc tìm kiếm, thuê phòng trọ và cuộc sống tự lập tại Hà Nội
          </p>
          {/* Search */}
            ...
            <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-400">
                  <span className="flex items-center gap-1"><Eye className="size-3.5" />{featuredPost.views.toLocaleString()}</span>
                  <span className="flex items-center gap-1"><Heart className="size-3.5" />{featuredPost.likes}</span>
                  <span className="flex items-center gap-1"><MessageCircle className="size-3.5" />{featuredPost.comments}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            {paginatedPosts.length === 0 ? (
              <div className="text-center py-20 bg-gray-50 rounded-2xl">
                ...
                <h3 className="text-lg font-semibold text-gray-500 mb-2">Không tìm thấy bài viết</h3>
                <p className="text-sm text-gray-400">Thử thay đổi từ khóa hoặc danh mục khác</p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-3 text-xs text-gray-400 mb-2.5">
                        ...
                        <span className="flex items-center gap-1"><Eye className="size-3.5" />{post.views.toLocaleString()}</span>
                      </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-6 text-white shadow-lg">
              ...
              <p className="text-green-100 text-sm mb-4 leading-relaxed">
                Đăng ký để nhận bài viết mới nhất về kinh nghiệm tìm trọ và xu hướng thị trường
              </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {POPULAR_TAGS.map(tag => (
                  <button
                    key={tag}
                    onClick={() => { setSearchQuery(tag); setActiveCategory('Tất cả'); setCurrentPage(1); }}

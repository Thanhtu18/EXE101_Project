...
import {
  Check, ChevronLeft, Shield, Lock, CreditCard, Smartphone,
  Calendar, MapPin, Home, Star, AlertCircle, CheckCircle2,
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center p-8 max-w-md">
            ...
            <p className="text-gray-600 mb-6 text-sm">
              Phiên làm việc đã hết hạn hoặc xảy ra lỗi. Vui lòng quay lại và điền lại thông tin.
            </p>
            <Button
  ...
  const handleVNPayComplete = () => {
    navigate('/payment-success', {
      state: {
        type: checkoutType,
        tier: isInspection
          ? { id: 'inspection', name: 'Ki\u1ec3m tra th\u1ef1c \u0111\u1ecba', price: 199000 }
          : selectedTier,
        amount: totalAmount,
        orderId: 'MH' + Date.now(),
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            <Button
              variant="ghost"
              onClick={() => navigate(isInspection ? '/admin/dashboard' : '/pricing')}
              className="mb-4"
            >
              <ChevronLeft className="size-4 mr-2" />
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                {isInspection ? 'Thanh to\u00e1n ki\u1ec3m tra th\u1ef1c \u0111\u1ecba' : 'X\u00e1c nh\u1eadn \u0111\u01a1n h\u00e0ng'}
              </h1>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardDescription className="flex items-center gap-2 text-base">
                          ...
                          Lo\u1ea1i:{' '}
                          <strong>
                            {inspectionTypeLabels[inspectionData.inspectionType] || 'Ki\u1ec3m tra ti\u00eau chu\u1ea9n'}
                          </strong>
                        </CardDescription>
                      </div>
                      <div className="text-right">
                        <div className="text-3xl font-bold text-blue-600">199.000\u0111</div>
                      ...
                      {[
                        ...
                        <li key={idx} className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                            <Check className="size-3.5 text-blue-600" strokeWidth={3} />
                          </div>
                    ...
                    <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700">
                          Sau khi thanh to\u00e1n, \u0111\u1ed9i ng\u0169 s\u1ebd li\u00ean h\u1ec7 trong v\u00f2ng 24h \u0111\u1ec3 x\u00e1c nh\u1eadn l\u1ecbch h\u1eb9n
                        </p>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-medium text-gray-900">{inspectionData.landlordName}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">S\u0110T:</span>
                          <span className="ml-2 font-medium text-gray-900">{inspectionData.landlordPhone}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-medium text-gray-900">{inspectionData.propertyName}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">S\u1ed1 ph\u00f2ng:</span>
                          <span className="ml-2 font-medium text-gray-900">{inspectionData.roomCount || 'N/A'}</span>
                        </div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-semibold text-blue-900">
                            {new Date(inspectionData.scheduledDate).toLocaleDateString('vi-VN', {
                              weekday: 'long',
                              day: '2-digit',
                              month: '2-digit',
                              year: 'numeric',
                        ...
                        <div>
                          ...
                          <span className="ml-2 font-semibold text-blue-900">{inspectionData.scheduledTime}</span>
                        </div>
                        <div className="col-span-2">
                      ...
                      {inspectionData.notes && (
                        <div className="mt-3 pt-3 border-t border-blue-200">
                          <span className="text-blue-600 text-sm">Ghi ch\u00fa:</span>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700">
                          G\u00f3i d\u1ecbch v\u1ee5 s\u1ebd \u0111\u01b0\u1ee3c \u00e1p d\u1ee5ng t\u1ef1 \u0111\u1ed9ng cho tin \u0111\u0103ng c\u1ee7a b\u1ea1n
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          123 \u0110\u01b0\u1eddng L\u00e1ng, Ph\u01b0\u1eddng L\u00e1ng Th\u01b0\u1ee3ng, Qu\u1eadn \u0110\u1ed1ng \u0110a, H\u00e0 N\u1ed9i
                        </p>
                      </div>
                    </div>
                    <Separator />
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-medium text-gray-900">Ph\u00f2ng tr\u1ecd</span>
                      </div>
                      <div>
                        <span className="text-gray-500">Di\u1ec7n t\u00edch:</span>
                        <span className="ml-2 font-medium text-gray-900">25m\u00b2</span>
                      </div>
                      <div>
                        <span className="text-gray-500">Gi\u00e1 thu\u00ea:</span>
                        <span className="ml-2 font-medium text-gray-900">3.000.000\u0111/th\u00e1ng</span>
                      </div>
                      <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                  <p>B\u1eb1ng vi\u1ec7c thanh to\u00e1n, b\u1ea1n \u0111\u1ed3ng \u00fd v\u1edbi c\u00e1c \u0111i\u1ec1u kho\u1ea3n sau:</p>
                  <ul className="list-disc list-inside space-y-1.5 ml-2">
                    {isInspection ? (
                      <>
                        <li>Ph\u00ed ki\u1ec3m tra th\u1ef1c \u0111\u1ecba l\u00e0 199.000\u0111/l\u1ea7n, kh\u00f4ng ho\u00e0n l\u1ea1i sau khi \u0111\u1ed9i ng\u0169 \u0111\u00e3 x\u00e1c nh\u1eadn l\u1ecbch</li>
                        <li>\u0110\u1ed9i ng\u0169 ki\u1ec3m tra s\u1ebd li\u00ean h\u1ec7 x\u00e1c nh\u1eadn l\u1ecbch h\u1eb9n trong v\u00f2ng 24h</li>
                        <li>K\u1ebft qu\u1ea3 ki\u1ec3m tra s\u1ebd \u0111\u01b0\u1ee3c g\u1eedi b\u00e1o c\u00e1o chi ti\u1ebft trong 48h sau ki\u1ec3m tra</li>
                        <li>N\u1ebfu h\u1ee7y tr\u01b0\u1edbc khi \u0111\u1ed9i ng\u0169 x\u00e1c nh\u1eadn, b\u1ea1n s\u1ebd \u0111\u01b0\u1ee3c ho\u00e0n ti\u1ec1n 100%</li>
                        <li>MapHome cam k\u1ebft b\u1ea3o m\u1eadt th\u00f4ng tin thanh to\u00e1n c\u1ee7a b\u1ea1n</li>
                      </>
                    ) : (
                      <>
                        <li>G\u00f3i d\u1ecbch v\u1ee5 s\u1ebd \u0111\u01b0\u1ee3c k\u00edch ho\u1ea1t ngay sau khi thanh to\u00e1n th\u00e0nh c\u00f4ng</li>
                        <li>Th\u1eddi h\u1ea1n s\u1eed d\u1ee5ng b\u1eaft \u0111\u1ea7u t\u00ednh t\u1eeb th\u1eddi \u0111i\u1ec3m k\u00edch ho\u1ea1t</li>
                        <li>B\u1ea1n c\u00f3 th\u1ec3 h\u1ee7y \u0111\u0103ng k\u00fd b\u1ea5t k\u1ef3 l\u00fac n\u00e0o trong ph\u1ea7n C\u00e0i \u0111\u1eb7t</li>
                        <li>Ch\u00ednh s\u00e1ch ho\u00e0n ti\u1ec1n 100% trong v\u00f2ng 7 ng\u00e0y \u0111\u1ea7u ti\u00ean</li>
                        <li>MapHome cam k\u1ebft b\u1ea3o m\u1eadt th\u00f4ng tin thanh to\u00e1n c\u1ee7a b\u1ea1n</li>
                      </>
                    )}
                  </ul>
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  >
                    ...
                    <a href="/policy" className="text-blue-600 hover:underline font-medium">
                      \u0111i\u1ec1u kho\u1ea3n s\u1eed d\u1ee5ng
                    </a>{' '}
                    v\u00e0{' '}
                    <a href="/policy" className="text-blue-600 hover:underline font-medium">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-start justify-between text-sm">
                      <div>
                        <p className="font-medium text-gray-900">
                          {isInspection ? 'Ki\u1ec3m tra th\u1ef1c \u0111\u1ecba' : selectedTier.name}
                        </p>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <p className="font-medium text-green-600">
                        {serviceFee === 0 ? 'Mi\u1ec5n ph\u00ed' : serviceFee.toLocaleString('vi-VN') + '\u0111'}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-[10px] text-gray-600 font-medium">QR Pay</p>
                        </div>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 flex items-center justify-center">
                        <div className="text-center">
                          <CreditCard className="size-6 text-gray-600 mx-auto mb-1" />
                          <p className="text-[10px] text-gray-600 font-medium">ATM</p>
                        </div>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 flex items-center justify-center">
                        <div className="text-center">
                          <div className="text-lg font-bold text-blue-700 mb-1">VISA</div>
                        </div>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-[10px] text-gray-600 font-medium">MoMo</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-xs text-green-800 leading-relaxed">
                      <strong>B\u1ea3o m\u1eadt 100%.</strong> M\u1ecdi giao d\u1ecbch \u0111\u01b0\u1ee3c m\u00e3 h\u00f3a SSL 256-bit.
                      MapHome kh\u00f4ng l\u01b0u tr\u1eef th\u00f4ng tin th\u1ebb c\u1ee7a b\u1ea1n.
                    </p>
                  </div>
                  ...
                  {!agreedToTerms && (
                    <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                      ...
                      <p className="text-xs text-amber-800">
                        Vui l\u00f2ng \u0111\u1ed3ng \u00fd v\u1edbi \u0111i\u1ec1u kho\u1ea3n s\u1eed d\u1ee5ng \u1edf ph\u1ea7n b\u00ean tr\u00e1i \u0111\u1ec3 ti\u1ebfp t\u1ee5c
                      </p>
                    </div>
                  )}
                </CardContent>

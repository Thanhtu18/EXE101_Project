  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-gray-50 overflow-hidden">
      ...
      <motion.header 
        ...
        className="bg-white shadow-sm border-b z-20"
      >
            ...
            <AnimatePresence>
              {selectedProperty && (
                <motion.div 
                  ...
                  className="w-1/3 h-full bg-white border-l shadow-2xl overflow-y-auto z-10"
                >
                  ...
                  >
                    ...
                    {selectedProperty.pinInfo && (
                      <div className="mt-4 p-3 bg-orange-50 rounded-xl border border-orange-100 shadow-sm">
                    ...
                    {/* Distance Info */}
                    <div className="mt-4 p-3 bg-blue-50 rounded-xl border border-blue-100 shadow-sm">
                    ...
                    {/* View Detail Button */}
                    <Button
                      className="mt-6 w-full bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all h-11"

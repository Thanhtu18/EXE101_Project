...
const extraGalleryImages: string[] = [];
...
const facilityTypeIcons: Record<
  string,
  { icon: typeof Hospital; label: string; color: string }
> = {
...
function MiniMap({ property }: { property: RentalProperty }) {
  ...
  const nearbyFacilities = useMemo(() => {
    return []; // Empty for now until facility API is ready
  }, []);
...
export function RoomDetailPage() {
  ...
  const galleryImages = useMemo(() => {
    ...
    // Add extras only if available
    if (extraGalleryImages.length > 0) {
      const offset = parseInt(property.id) % extraGalleryImages.length;
      for (let i = 0; i < Math.min(3, extraGalleryImages.length); i++) {
                ...
                <div className="space-y-6">
                  ...
                  {property.greenBadge &&
                    property.greenBadge.level === "verified" && (
                      <div
                        className="relative overflow-hidden rounded-2xl border-4 border-green-400 shadow-2xl"
                        style={{
                          background:
                            "linear-gradient(135deg, #ecfdf5 0%, #d1fae5 50%, #a7f3d0 100%)",
                          boxShadow:
                            "0 0 40px rgba(34, 197, 94, 0.4), 0 10px 30px rgba(0, 0, 0, 0.15)",
                        }}
                      >
                        {/* Decorative corner */}
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center animate-bounce">
                                  <Check
                                    className="size-5 text-white font-bold"
                                    strokeWidth={4}
                                  />
                                </div>
                              </div>
                              <p className="text-green-800 font-semibold text-base mb-2">
                                MapHome đã kiểm tra thực địa và xác nhận căn trọ
                                này
                              </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <div className="flex gap-3 items-start p-3 bg-green-50 rounded-lg border border-green-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-800">
                                    Đã kiểm tra thực địa bởi đội ngũ MapHome,
                                    đảm bảo không phải tin ảo
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="flex gap-3 items-start p-3 bg-green-50 rounded-lg border border-green-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-800">
                                    GPS đã được xác minh, bạn không lo bị dẫn
                                    nhầm địa chỉ
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="flex gap-3 items-start p-3 bg-green-50 rounded-lg border border-green-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-800">
                                    Giá, diện tích, tiện ích đã được kiểm chứng
                                    khớp với thực tế
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="flex gap-3 items-start p-3 bg-green-50 rounded-lg border border-green-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-800">
                                    Đã hợp tác với MapHome, cam kết chất lượng
                                    dịch vụ
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-blue-800 mb-3">
                                  ...
                                  để được đội ngũ MapHome kiểm tra thực địa,
                                  chụp ảnh, xác minh thông tin. Điều này chứng
                                  tỏ sự nghiêm túc và cam kết chất lượng!
                                </p>
                  ...
                  {(!property.greenBadge ||
                    property.greenBadge.level === "none") && (
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-bold text-amber-900 mb-2 text-lg">
                            Căn trọ chưa được xác thực
                          </h4>
                          <p className="text-sm text-amber-800 mb-3">
                            Tin đăng này chưa được MapHome kiểm tra thực địa.
                            Bạn có thể yêu cầu admin đến kiểm tra để bảo vệ bản
                            thân khỏi tin ảo!
                          </p>
                          ...
                          <p className="text-xs text-amber-600 mt-2 text-center">
                            💡 Miễn phí cho người thuê trọ - Admin sẽ đến thực
                            địa xác minh
                          </p>
                        </div>
                      </div>

          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
            {[
              ...
              },
              {
                ...
                title: "Trust is King",
                desc: "Hệ thống xác thực 2 cấp độ: Chưa xác thực và đã xác thực vị trí GPS",
              },
            ].map((f) => (
              <div
                key={f.title}
              ...
              >
                <div
                  className={`bg-gradient-to-br ${f.gradient} w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}
                >

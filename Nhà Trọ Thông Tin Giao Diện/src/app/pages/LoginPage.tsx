                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    >
                      ...
                      />
                      <div className="font-medium text-[13px]">Chủ trọ</div>
                    ...
                    >
                      ...
                      />
                      <div className="font-medium text-[13px]">Người tìm trọ</div>
                      <div className="text-[10px] text-gray-500">Tìm phòng ở</div>
                    </button>
                    <button
                      type="button"
                      onClick={() =>
                    ...
                    >
                      ...
                      />
                      <div className="font-medium text-[13px]">Quản trị viên</div>
                      <div className="text-[10px] text-gray-500">Quản lý hệ thống</div>
                    </button>
                  </div>
                </div>

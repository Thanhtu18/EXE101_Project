...
import { Home, Lock, User, Mail, Phone, AlertCircle, CheckCircle, Shield, Building2 } from 'lucide-react';
...
export function LoginPage() {
  ...
  const [registerData, setRegisterData] = useState({
    ...
    fullName: '',
    phone: '',
    role: 'landlord' as 'landlord' | 'user',
  });
  ...
  const handleSocialLogin = (provider: 'google' | 'zalo') => {
    ...
    setError(`Đăng nhập bằng ${provider === 'google' ? 'Google' : 'Zalo'} đang được phát triển`);
  };
    ...
    <div className="min-h-screen w-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-green-600 to-blue-700">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1200&h=1200&fit=crop&q=80)',
          }}
        >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-500">Đăng tin cho thuê</div>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <User
                        className={`size-6 mx-auto mb-2 ${
                          registerData.role === 'user' ? 'text-blue-600' : 'text-gray-400'
                        }`}
                      />
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                <svg className="size-5 mr-2" viewBox="0 0 48 48" fill="none">
                  ...
                  <path d="M15 22.5C15 19.5 17.5 17 20.5 17H27.5C30.5 17 33 19.5 33 22.5V25.5C33 28.5 30.5 31 27.5 31H24L19 35V31C16.8 31 15 29.2 15 27V22.5Z" fill="white"/>
                </svg>
                Tiếp tục với Zalo
              </Button>
            </div>
